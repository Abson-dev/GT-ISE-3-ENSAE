...
global main          "C:\Users\AHema\OneDrive - CGIAR\Desktop\Cours\2025\ENSAE\GT ISE 3 ENSAE\00_Data"
global data_input       	"$main\00_INPUTS\00_EHCVM"
global data_output       	"$main\01_OUTPUTS\00_EHCVM"

/////////////
//global iso3_country1 "BEN"
//global iso3_country2 "ben"

//global folder concat(iso3_country1 "2021_EHCVM-P_v02_M_Stata"), punct(_)

//global welfare_file concat(iso3_country1 "2021_EHCVM-P_v02_M_Stata"), punct(_)
/////////////////////
...
use "$data_input\BEN\BEN_2021_EHCVM-2_v01_M_STATA14\ehcvm_welfare_ben2021.dta",clear
...
save "$data_output\BEN\HH_survey_ehcvm_ben_2021.dta",replace
...
use "$data_input\BEN\BEN_2021_EHCVM-2_v01_M_STATA14\ehcvm_menage_ben2021.dta",clear
...
merge 1:1 hhid using "$data_output\BEN\HH_survey_ehcvm_ben_2021.dta"
...
use "$data_input\BEN\BEN_2021_EHCVM-2_v01_M_STATA14\ehcvm_individu_ben2021.dta",clear
...
save "$data_output\BEN\ehcvm_individu_ben2021_with_dummy.dta",replace

use "$data_output\BEN\ehcvm_individu_ben2021_with_dummy.dta", clear

collapse (mean) age resid*	sexe*	lien*	mstat*	religion*	ethnie*	nation*	mal30j*	aff30j*	arrmal*	hos12m1	hos12m2	couvmal1	couvmal2	handit1	handit2	alfa1	alfa2	educ_scol1	educ_scol2	educ_scol3	educ_scol4	educ_scol5	educ_scol6	educ_scol7	educ_scol8	educ_hi1	educ_hi2	educ_hi3	educ_hi4	educ_hi5	educ_hi6	educ_hi7	educ_hi8	educ_hi9	diplome1	diplome2	diplome3	diplome4	diplome5	diplome6	diplome7	diplome8	diplome9	diplome10	diplome11	telpor1	telpor2	internet1	internet2	activ7j1	activ7j2	activ7j3	activ7j4	activ7j5	activ7j6	activ12m1	activ12m2	activ12m3	activ12m4	branch1	branch2	branch3	branch4	branch5	branch6	branch7	branch8	branch9	branch10	branch11	sectins*	csp*	emploi_sec1	emploi_sec2	bank1	bank2	serviceconsult*	persconsult* [aw=hhweight], by(hhid)
...
// Merge with HDX Data
*===============================================================================
use "C:\Users\AHema\OneDrive - CGIAR\Desktop\Poverty Mapping\Small area estimation\Burkina Faso\Application of Fay-Herriot Model for Burkina Faso\00.Data\EHCVM data\BFA_2021_EHCVM-P_v02_M_Stata\BFA_HDX_ADM3_EHCVM_Matching.dta", clear 

merge m:1 hhid using "$data_output\BEN\HH_survey_ehcvm_ben_2021.dta"
/*
...
save "$data_output\BEN\BEN_survey_ehcvm_2021_adm3.dta",replace
*/